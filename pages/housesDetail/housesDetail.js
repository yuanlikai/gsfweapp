...
Page({
  ...
  clicks(){
    let v = this;
    wx.navigateTo({
      url: '/pages/map/map?mobile=' + v.data.detail.hou_mobile + '&address=' + v.data.detail.hou_address + '&name=' + v.data.detail.hou_names + '&latitude=' + v.data.markers[0].latitude + '&longitude=' + v.data.markers[0].longitude
    })
  },
